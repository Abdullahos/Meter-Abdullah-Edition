#include "/home/pi/Desktop/meter/measurements/recordReadings.h" 
FILE *filePointer1;
...
*/     
      	...
      	filePointer1 = fopen(FileName,"a");	// W -> For create text file ,, a -> For upadte in exciting file
	  struct flock lock;
	...
	// file descriptor to identify a file within a process 
	  ...
	  else 
	  {
	    //write(fd, DataString, strlen(DataString)); // populate data file 
	     fprintf(filePointer1,"%s",DataString);
